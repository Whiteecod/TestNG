...
public class _01_SoftAssertVsHardAssert {
    ...
    void hardAssert() {
     String s1="Merhaba";
        ...
        Assert.assertEquals("Merhaba", s1, "Oluşan la bekleme eşit değil."); // test kırılıyor burada
    ...
    void softAssert() {
        ...
        // bu bölüm assertAlldan sonra olduğu ve öncesinde hata oluştuğu için ekrana çıkmayacak
    }
}
